...
from pydoll.protocol.types.commands import Command
from pydoll.protocol.types.commands.dom_commands_types import (
...
from pydoll.protocol.types.responses import Response
from pydoll.protocol.types.responses.dom_responses_types import (
...
class DomCommands:
    ...
    def describe_node(
        ...
        return Command(method='DOM.describeNode', params=params)
    ...
    def disable() -> Command[Response]:
        ...
        """
        return Command(method='DOM.disable')
    ...
    def enable(include_whitespace: Optional[IncludeWhitespace] = None) -> Command[Response]:
        ...
        return Command(method='DOM.enable', params=params)
    ...
    def focus(
        ...
        if object_id:
            params['objectId'] = object_id
        return Command(method='DOM.focus', params=params)
    ...
    def get_attributes(node_id: int) -> Command[GetAttributesResponse]:
        ...
        return Command(method='DOM.getAttributes', params=params)
    ...
    def get_box_model(
        ...
        if object_id:
            params['objectId'] = object_id
        return Command(method='DOM.getBoxModel', params=params)
    ...
    def get_document(
        ...
        if pierce:
            params['pierce'] = pierce
        return Command(method='DOM.getDocument', params=params)
    ...
    def get_node_for_location(
        ...
        return Command(method='DOM.getNodeForLocation', params=params)
    ...
    def get_outer_html(
        ...
        if object_id:
            params['objectId'] = object_id
        return Command(method='DOM.getOuterHTML', params=params)
    ...
    def hide_highlight() -> Command[Response]:
        ...
        """
        return Command(method='DOM.hideHighlight')
    ...
    def highlight_node() -> Command[Response]:
        ...
        """
        return Command(method='DOM.highlightNode')
    ...
    def highlight_rect() -> Command[Response]:
        ...
        """
        return Command(method='DOM.highlightRect')
    ...
    def move_to(
        ...
        return Command(method='DOM.move', params=params)
    ...
    def query_selector(
        ...
        return Command(method='DOM.querySelector', params=params)
    ...
    def query_selector_all(
        ...
        return Command(method='DOM.querySelectorAll', params=params)
    ...
    def remove_attribute(
        ...
        return Command(method='DOM.removeAttribute', params=params)
    ...
    def remove_node(node_id: int) -> Command[Response]:
        ...
        return Command(method='DOM.removeNode', params=params)
    ...
    def request_child_nodes(
        ...
        if pierce:
            params['pierce'] = pierce
        return Command(method='DOM.requestChildNodes', params=params)
    ...
    def request_node(
        ...
        return Command(method='DOM.requestNode', params=params)
    ...
    def resolve_node(
        ...
        return Command(method='DOM.resolveNode', params=params)
    ...
    def scroll_into_view_if_needed(
        ...
        if rect:
            params['rect'] = rect
        return Command(method='DOM.scrollIntoViewIfNeeded', params=params)

    @staticmethod
    def set_attribute_as_text(
        node_id: int,
        text: str,
        ...
        if name:
            params['name'] = name
        return Command(method='DOM.setAttributeAsText', params=params)
    ...
    def set_attribute_value(
        ...
        return Command(method='DOM.setAttributeValue', params=params)
    ...
    def set_file_input_files(
        ...
        if object_id:
            params['objectId'] = object_id
        return Command(method='DOM.setFileInputFiles', params=params)
    ...
    def set_node_name(
        ...
        return Command(method='DOM.setNodeName', params=params)
    ...
    def set_node_value(
        ...
        return Command(method='DOM.setNodeValue', params=params)
    ...
    def set_outer_html(
        ...
        return Command(method='DOM.setOuterHTML', params=params)
    ...
    def collect_class_names_from_subtree(
        ...
        return Command(method='DOM.collectClassNamesFromSubtree', params=params)
    ...
    def copy_to(
        ...
        if insert_before_node_id:
            params['insertBeforeNodeId'] = insert_before_node_id
        return Command(method='DOM.copyTo', params=params)
    ...
    def discard_search_results(
        ...
        return Command(method='DOM.discardSearchResults', params=params)
    ...
    def get_anchor_element(
        ...
        return Command(method='DOM.getAnchorElement', params=params)
    ...
    def get_container_for_node(
        ...
        return Command(method='DOM.getContainerForNode', params=params)
    ...
    def get_content_quads(
        ...
        if object_id:
            params['objectId'] = object_id
        return Command(method='DOM.getContentQuads', params=params)
    ...
    def get_detached_dom_nodes() -> Command[GetDetachedDomNodesResponse]:
        ...
        """
        return Command(method='DOM.getDetachedDomNodes')
    ...
    def get_element_by_relation(
        ...
        return Command(method='DOM.getElementByRelation', params=params)
    ...
    def get_file_info(
        ...
        return Command(method='DOM.getFileInfo', params=params)
    ...
    def get_frame_owner(
        ...
        return Command(method='DOM.getFrameOwner', params=params)
    ...
    def get_nodes_for_subtree_by_style(
        ...
        if pierce:
            params['pierce'] = pierce
        return Command(method='DOM.getNodesForSubtreeByStyle', params=params)
    ...
    def get_node_stack_traces(
        ...
        return Command(method='DOM.getNodeStackTraces', params=params)

    @staticmethod
    def get_querying_descendant_for_container(
        node_id: int,
        ...
        return Command(method='DOM.getQueryingDescendantForContainer', params=params)
    ...
    def get_relayout_boundary(
        ...
        return Command(method='DOM.getRelayoutBoundary', params=params)
    ...
    def get_search_results(
        ...
        return Command(method='DOM.getSearchResults', params=params)
    ...
    def get_top_layer_elements() -> Command[GetTopLayerElementsResponse]:
        ...
        """
        return Command(method='DOM.getTopLayerElements')
    ...
    def mark_undoable_state() -> Command[Response]:
        ...
        """
        return Command(method='DOM.markUndoableState')
    ...
    def perform_search(
        ...
        if include_user_agent_shadow_dom:
            params['includeUserAgentShadowDOM'] = include_user_agent_shadow_dom
        return Command(method='DOM.performSearch', params=params)
    ...
    def push_node_by_path_to_frontend(
        ...
        return Command(method='DOM.pushNodeByPathToFrontend', params=params)
    ...
    def push_nodes_by_backend_ids_to_frontend(
        ...
        return Command(method='DOM.pushNodesByBackendIdsToFrontend', params=params)
    ...
    def redo() -> Command[Response]:
        ...
        """
        return Command(method='DOM.redo')
    ...
    def set_inspected_node(
        ...
        return Command(method='DOM.setInspectedNode', params=params)
    ...
    def set_node_stack_traces_enabled(
        ...
        return Command(method='DOM.setNodeStackTracesEnabled', params=params)
    ...
    def undo() -> Command[Response]:
        ...
        """
        return Command(method='DOM.undo')
