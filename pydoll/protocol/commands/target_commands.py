...
from pydoll.protocol.types.commands.target_commands_types import (
...
from pydoll.protocol.types.responses.target_responses_types import (
...
class TargetCommands:
    ...
    def activate_target(target_id: str) -> Command[Response]:
        ...
        return Command(method='Target.activateTarget', params=params)
    ...
    def attach_to_target(
        ...
        return Command(method='Target.attachToTarget', params=params)
    ...
    def close_target(target_id: str) -> Command[Response]:
        ...
        return Command(method='Target.closeTarget', params=params)
    ...
    def create_browser_context(
        ...
        return Command(method='Target.createBrowserContext', params=params)
    ...
    def detach_from_target(session_id: Optional[str] = None) -> Command[Response]:
        ...
        return Command(method='Target.detachFromTarget', params=params)
    ...
    def dispose_browser_context(browser_context_id: str) -> Command[Response]:
        ...
        return Command(method='Target.disposeBrowserContext', params=params)
    ...
    def get_browser_contexts() -> Command[GetBrowserContextsResponse]:
        ...
        """
        return Command(method='Target.getBrowserContexts')
    ...
    def get_targets(filter: Optional[List] = None) -> Command[GetTargetsResponse]:
        ...
        return Command(method='Target.getTargets', params=params)
    ...
    def set_auto_attach(
        ...
        if filter:
            params['filter'] = filter
        return Command(method='Target.setAutoAttach', params=params)
    ...
    def set_discover_targets(discover: bool, filter: Optional[List] = None) -> Command[Response]:
        ...
        if filter:
            params['filter'] = filter
        return Command(method='Target.setDiscoverTargets', params=params)
    ...
    def attach_to_browser_target(session_id: str) -> Command[AttachToBrowserTargetResponse]:
        ...
        return Command(method='Target.attachToBrowserTarget', params=params)
    ...
    def get_target_info(target_id: str) -> Command[GetTargetInfoResponse]:
        ...
        return Command(method='Target.getTargetInfo', params=params)
    ...
    def set_remote_locations(locations: List[RemoteLocation]) -> Command[Response]:
        ...
        return Command(method='Target.setRemoteLocations', params=params)
