class StorageCommands:
    """
    A class for interacting with browser storage using Chrome DevTools Protocol.
    
    This class provides methods to create commands for managing cookies in the browser,
    including retrieving, setting, and clearing cookies through CDP commands.
