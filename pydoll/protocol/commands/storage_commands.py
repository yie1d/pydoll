...
from pydoll.protocol.types.commands.base_commands_types import Command
from pydoll.protocol.types.commands.storage_commands_types import (
    ClearCookiesParams,
...
class StorageCommands:
    ...
    def clear_data_for_origin(origin: str, storage_types: str) -> Command[Response]:
        ...
        return Command(method='Storage.clearDataForOrigin', params=params)
    ...
    def clear_data_for_storage_key(storage_key: str, storage_types: str) -> Command[Response]:
        ...
        return Command(method='Storage.clearDataForStorageKey', params=params)
    ...
    def get_storage_key_for_frame(frame_id: str) -> Command[GetStorageKeyForFrameResponse]:
        ...
        return Command(method='Storage.getStorageKeyForFrame', params=params)
    ...
    def get_usage_and_quota(origin: str) -> Command[GetUsageAndQuotaResponse]:
        ...
        return Command(method='Storage.getUsageAndQuota', params=params)
    ...
    def set_protected_audience_k_anonymity(
        ...
        return Command(method='Storage.setProtectedAudienceKAnonymity', params=params)
    ...
    def track_cache_storage_for_origin(origin: str) -> Command[Response]:
        ...
        return Command(method='Storage.trackCacheStorageForOrigin', params=params)
    ...
    def track_cache_storage_for_storage_key(storage_key: str) -> Command[Response]:
        ...
        return Command(method='Storage.trackCacheStorageForStorageKey', params=params)
    ...
    def track_indexed_db_for_origin(origin: str) -> Command[Response]:
        ...
        return Command(method='Storage.trackIndexedDBForOrigin', params=params)
    ...
    def track_indexed_db_for_storage_key(storage_key: str) -> Command[Response]:
        ...
        return Command(method='Storage.trackIndexedDBForStorageKey', params=params)
    ...
    def untrack_cache_storage_for_origin(origin: str) -> Command[Response]:
        ...
        return Command(method='Storage.untrackCacheStorageForOrigin', params=params)
    ...
    def untrack_cache_storage_for_storage_key(storage_key: str) -> Command[Response]:
        ...
        return Command(method='Storage.untrackCacheStorageForStorageKey', params=params)
    ...
    def untrack_indexed_db_for_origin(origin: str) -> Command[Response]:
        ...
        return Command(method='Storage.untrackIndexedDBForOrigin', params=params)
    ...
    def untrack_indexed_db_for_storage_key(storage_key: str) -> Command[Response]:
        ...
        return Command(method='Storage.untrackIndexedDBForStorageKey', params=params)
    ...
    def clear_shared_storage_entries(owner_origin: str) -> Command[Response]:
        ...
        return Command(method='Storage.clearSharedStorageEntries', params=params)
    ...
    def clear_trust_tokens(issuer_origin: str) -> Command[ClearTrustTokensResponse]:
        ...
        return Command(method='Storage.clearTrustTokens', params=params)
    ...
    def delete_shared_storage_entry(owner_origin: str, key: str) -> Command[Response]:
        ...
        return Command(method='Storage.deleteSharedStorageEntry', params=params)
    ...
    def delete_storage_bucket(bucket: StorageBucket) -> Command[Response]:
        ...
        return Command(method='Storage.deleteStorageBucket', params=params)
    ...
    def get_interest_group_details(
        ...
        return Command(method='Storage.getInterestGroupDetails', params=params)
    ...
    def get_related_website_sets(
        ...
        return Command(method='Storage.getRelatedWebsiteSets', params=params)
    ...
    def get_shared_storage_entries(owner_origin: str) -> Command[GetSharedStorageEntriesResponse]:
        ...
        return Command(method='Storage.getSharedStorageEntries', params=params)
    ...
    def get_shared_storage_metadata(owner_origin: str) -> Command[GetSharedStorageMetadataResponse]:
        ...
        return Command(method='Storage.getSharedStorageMetadata', params=params)
    ...
    def get_trust_tokens() -> Command[GetTrustTokensResponse]:
        ...
        """
        return Command(method='Storage.getTrustTokens')
    ...
    def override_quota_for_origin(
        ...
        return Command(method='Storage.overrideQuotaForOrigin', params=params)
    ...
    def reset_shared_storage_budget(owner_origin: str) -> Command[Response]:
        ...
        return Command(method='Storage.resetSharedStorageBudget', params=params)
    ...
    def run_bounce_tracking_mitigations() -> Command[RunBounceTrackingMitigationsResponse]:
        ...
        """
        return Command(method='Storage.runBounceTrackingMitigations')
    ...
    def send_pending_attribution_reports() -> Command[SendPendingAttributionReportsResponse]:
        ...
        """
        return Command(method='Storage.sendPendingAttributionReports')
    ...
    def set_attribution_reporting_local_testing_mode(enable: bool) -> Command[Response]:
        ...
        return Command(method='Storage.setAttributionReportingLocalTestingMode', params=params)
    ...
    def set_attribution_reporting_tracking(enable: bool) -> Command[Response]:
        ...
        return Command(method='Storage.setAttributionReportingTracking', params=params)
    ...
    def set_interest_group_auction_tracking(enable: bool) -> Command[Response]:
        ...
        return Command(method='Storage.setInterestGroupAuctionTracking', params=params)
    ...
    def set_interest_group_tracking(enable: bool) -> Command[Response]:
        ...
        return Command(method='Storage.setInterestGroupTracking', params=params)
    ...
    def set_shared_storage_entry(
        ...
        return Command(method='Storage.setSharedStorageEntry', params=params)
    ...
    def set_shared_storage_tracking(enable: bool) -> Command[Response]:
        ...
        return Command(method='Storage.setSharedStorageTracking', params=params)
    ...
    def set_storage_bucket_tracking(storage_key: str, enable: bool) -> Command[Response]:
        ...
        return Command(method='Storage.setStorageBucketTracking', params=params)
