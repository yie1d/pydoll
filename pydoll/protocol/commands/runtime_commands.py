...
class RuntimeCommands:
    ...
    def add_binding(name: str, execution_context_name: Optional[str] = None) -> Command[Response]:
        ...
        return Command(method='Runtime.addBinding', params=params)
    ...
    def await_promise(
        ...
        return Command(method='Runtime.awaitPromise', params=params)
    ...
    def call_function_on(
        ...
        return Command(method='Runtime.callFunctionOn', params=params)
    ...
    def compile_script(
        ...
        return Command(method='Runtime.compileScript', params=params)
    ...
    def evaluate(
        ...
        return Command(method='Runtime.evaluate', params=params)
    ...
    def get_properties(
        ...
        return Command(method='Runtime.getProperties', params=params)
    ...
    def global_lexical_scope_names(
        ...
        return Command(method='Runtime.globalLexicalScopeNames', params=params)
    ...
    def query_objects(
        ...
        return Command(method='Runtime.queryObjects', params=params)
    ...
    def release_object(
        ...
        return Command(method='Runtime.releaseObject', params=params)
    ...
    def release_object_group(
        ...
        return Command(method='Runtime.releaseObjectGroup', params=params)
    ...
    def remove_binding(
        ...
        return Command(method='Runtime.removeBinding', params=params)
    ...
    def run_script(
        ...
        return Command(method='Runtime.runScript', params=params)
    ...
    def set_async_call_stack_depth(
        ...
        return Command(method='Runtime.setAsyncCallStackDepth', params=params)
    ...
    def set_custom_object_formatter_enabled(
        ...
        return Command(method='Runtime.setCustomObjectFormatterEnabled', params=params)
    ...
    def set_max_call_stack_size_to_capture(
        ...
        return Command(method='Runtime.setMaxCallStackSizeToCapture', params=params)
