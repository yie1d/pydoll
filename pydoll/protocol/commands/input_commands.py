...
from pydoll.protocol.types.commands.input_commands_types import (
...
class InputCommands:
    ...
    def cancel_dragging() -> Command[Response]:
        ...
        """
        return Command(method='Input.cancelDragging')
    ...
    def dispatch_key_event(
        ...
        Args:
            ...
            key: Unique DOM defined string value describing the meaning of the key in the context
        ...
        return Command(method='Input.dispatchKeyEvent', params=params)
    ...
    def dispatch_mouse_event(
        ...
        return Command(method='Input.dispatchMouseEvent', params=params)
    ...
    def dispatch_touch_event(
        ...
        if timestamp:
            params['timestamp'] = timestamp
        return Command(method='Input.dispatchTouchEvent', params=params)
    ...
    def set_ignore_input_events(enabled: bool) -> Command[Response]:
        ...
        return Command(method='Input.setIgnoreInputEvents', params=params)
    ...
    def dispatch_drag_event(
        ...
        if modifiers:
            params['modifiers'] = modifiers
        return Command(method='Input.dispatchDragEvent', params=params)
    ...
    def emulate_touch_from_mouse_event(
        ...
        if click_count:
            params['clickCount'] = click_count
        return Command(method='Input.emulateTouchFromMouseEvent', params=params)
    ...
    def ime_set_composition(
        ...
        Args:
            ...
            replacement_start: Start position of the text to be replaced (default: same as selection_start).
            replacement_end: End position of the text to be replaced (default: same as selection_end).
        ...
        return Command(method='Input.imeSetComposition', params=params)
    ...
    def insert_text(
        ...
        return Command(method='Input.insertText', params=params)
    ...
    def set_intercept_drags(enabled: bool) -> Command[Response]:
        ...
        return Command(method='Input.setInterceptDrags', params=params)
    ...
    def synthesize_pinch_gesture(
        ...
        return Command(method='Input.synthesizePinchGesture', params=params)
    ...
    def synthesize_scroll_gesture(
        ...
        return Command(method='Input.synthesizeScrollGesture', params=params)
    ...
    def synthesize_tap_gesture(
        ...
        if gesture_source_type:
            params['gestureSourceType'] = gesture_source_type
        return Command(method='Input.synthesizeTapGesture', params=params)
