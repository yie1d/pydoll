...
class FindElementsMixin:
    ...
    async def wait_element(
        ...
        Args:
            by (SelectorType): The type of selector to use (e.g., 'css', 'xpath').
            value (str): The value of the selector to locate the element.
            timeout (int): Maximum time in seconds to wait for the element.
                Defaults to 10 seconds.
            raise_exc (bool): Whether to raise an exception if the element is not
                found within the timeout. Defaults to True.

        Returns:
            WebElement or None: The element found in the DOM, or None if not found
    ...
    async def _describe_node(self, object_id: str = '') -> dict:
        ...
        Returns:
            dict: A dictionary containing the detailed description of the node,
                including its attributes, properties, and other characteristics.
        """
    ...
    async def _execute_command(self, command: dict) -> dict:
        ...
        Returns:
            dict: The result of the command execution as returned by the browser.
        """
